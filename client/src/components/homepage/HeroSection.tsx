    ...
    return (
        <section className="lg:flex pt-24 pb-16 px-4 lg:pt-40 lg:pb-24 lg:px-72 bg-blue-800 text-white">
            <div>
                ...
                <Link href="/registerUser" className="bg-white hover:bg-slate-100 mb-4 lg:mb-0 py-4 px-6 font-bold text-gray-900 rounded-lg text-sm lg:text-lg uppercase text-center">
