...
function HeroSection() {
    ...
    return (
        <section className="lg:flex pt-24 pb-16 px-4 lg:pt-40 lg:pb-24 lg:px-60 bg-blue-800 text-white">
            <div>
                ...
                <p className="text-base lg:text-2xl pb-8 lg:pb-12 lg:pr-28">Junte-se a nós nesta jornada de solidariedade e impacto social. Vamos trabalhar juntos para construir um futuro melhor para todos.</p>
